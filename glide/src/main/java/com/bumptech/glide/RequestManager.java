...
public class RequestManager implements LifecycleListener {
     ...
     *     {@link com.bumptech.glide.GenericRequestBuilder#signature(Key)} to mixin a signature
     ...
     * @see com.bumptech.glide.GenericRequestBuilder#signature(Key)
     */
     ...
     * {@link com.bumptech.glide.DrawableRequestBuilder#signature(Key)} instead. Scheduled to be
     ...
     *     {@link com.bumptech.glide.GenericRequestBuilder#signature(Key)} to mix in some
     ...
     * {@link com.bumptech.glide.GenericRequestBuilder#signature(Key)} instead. Scheduled to be
     * removed in Glide 4.0.
