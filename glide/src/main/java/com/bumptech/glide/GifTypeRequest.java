...
public class GifTypeRequest<ModelType> extends GifRequestBuilder<ModelType> {
    ...
    private static <A, R> FixedLoadProvider<A, InputStream, GifDrawable, R> buildProvider(
            Glide glide,
        ...
        DataLoadProvider<InputStream, GifDrawable> dataLoadProvider =
                glide.buildDataProvider(InputStream.class,
                        GifDrawable.class);
        return new FixedLoadProvider<A, InputStream, GifDrawable, R>(streamModelLoader, transcoder,
                dataLoadProvider);
    }
    ...
    GifTypeRequest(GenericRequestBuilder<ModelType, ?, ?, ?> other,
        ...
        //这里的ranscodeClass是GifDrawable
        super(buildProvider(other.glide, streamModelLoader, GifDrawable.class, null),
                GifDrawable.class, other);
    ...
    public <R> GenericRequestBuilder<ModelType, InputStream, GifDrawable, R> transcode(
        ...
        FixedLoadProvider<ModelType, InputStream, GifDrawable, R> provider =
                buildProvider(glide, streamModelLoader,
                        transcodeClass, transcoder);
        return optionsApplier
                .apply(new GenericRequestBuilder<ModelType, InputStream, GifDrawable, R>(provider,
                        transcodeClass, this));
    }
