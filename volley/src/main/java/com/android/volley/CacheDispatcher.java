...
public class CacheDispatcher extends Thread {
    ...
    private void processRequest() throws InterruptedException {
        ...
        //从mCacheQueue中阻塞地获取Request，直到该队列中有元素。
    ...
    void processRequest(final Request<?> request) throws InterruptedException {
        ...
        try {
            ...
            //如果在轮到该Request执行时，它已经被Cancel了，那么调用Request#finish方法，并取队列的下一个Request进行操作
            ...
            //尝试从缓存管理类mCache中取出该Request对应的缓存
            ...
            if (!entry.refreshNeeded()) {
                ...
                if (!mWaitingRequestManager.maybeAddToWaitingRequests(request)) {
                    ...
                    //给Request设置cacheEntry，在给使用者回调该结果后，还要再把该Request加入到网络队列
    ...
    private static class WaitingRequestManager implements Request.NetworkRequestCompleteListener {
         ...
         * </ul>
         */
        //它的Key是每个Request的getCacheKey，具有相同key的Request会被放在同一个队列当中。
